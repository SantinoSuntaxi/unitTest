...
class ModeloProductos{
	...
	static public function mdlMostrarProductos($tabla, $item, $valor, $orden){
		...
		if($item != null){
			...
			$stmt = ConexionLecciones::conectarLecciones()->prepare("SELECT * FROM $tabla WHERE $item = :$item ORDER BY id DESC");
			...
			$stmt = ConexionLecciones::conectarLecciones()->prepare("SELECT * FROM $tabla ORDER BY $orden DESC");
	...
	static public function mdlMostrarSumaVentas($tabla){
		...
		$stmt = ConexionLecciones::conectarLecciones()->prepare("SELECT SUM(numerovisitas) as total FROM $tabla");
